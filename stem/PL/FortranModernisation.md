...
But unlike the simple type theory, the dependent type theory has no type inferencing, per se. Simply put, this inability to infer types is a consequence of the expressive power of the dependent type system: lifting complicated, runtime computations up to the type level makes type inferencing undecidable at compile-time, which is analogous to the halting being undecidable at runtime. Technically, this issue stems from the [undecidability of the judgemental equality](https://www.cse.chalmers.se/research/group/logic/book/book.pdf) in extensional type theories.
