...
- $x^{y/z} = \color{darkred}ln^{-1}\color{black}[y ÷ z × \color{red}ln\color{black}(x)]$
  - $= \color{darkred}ln^{-1}\color{black}[\color{darkblue}log^{-1}\color{black}[\color{blue}log\color{black}(y ÷ z × \color{red}ln\color{black}(x)]$
  - $= \color{darkred}ln^{-1}\color{black}[\color{darkblue}log^{-1}\color{black}[\color{blue}log\color{black}(y) - \color{blue}log\color{black}(z) + \color{blue}log\color{black}(\color{red}ln\color{black}(x))]]$
