...
- $x^{y/z} = \color{darkred}{ln^{-1}}[y ÷ z × \color{red}{ln}(x)]$
  - $= \color{darkred}{ln^{-1}}[\color{darkgreen}{log^{-1}}[\color{green}{log}[y ÷ z × \color{red}{ln}(x)]$
  - $= \color{darkred}{ln^{-1}}[\color{darkgreen}{log^{-1}}[\color{green}{log}(y) - \color{green}{log}(z) + \color{green}{log}(\color{red}{ln}(x))]]$
