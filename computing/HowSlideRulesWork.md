...
Here is a little perspective. In the 1950s, an ordinary engineering slide rule, like the K&E 4081-3, was priced around 20 dollars, now. In today's money, that slide rule would cost about 230 dollars. By way of comparison, the [HP Prime](https://www.hp.com/us-en/campaigns/prime-graphing-calculator/overview.html) calculator—the ultimate weapon of an engineer—with reverse Polish notation (RPN), computer algebra system (CAS), BASIC programming language, 3D plotting, colour touchscreen, and a whole lot more, costs less than 150 dollars, new, in 2021. A refurbished Dell laptop with Intel Core i5 CPU and 4 GB of RAM costs about 130 dollars. Are you all astonishment?
