...
The term "log-log" refers to the $LL$ scale, which is used to compute exponentiation, as will be explained, later. The term "duplex" refers to the fact that both sides of the frame are engraved with scales, a K&E invention. The term "decitrig" was K&E's trade name for its slide rules that used decimal degrees for trigonometric computations, instead of minutes and seconds. Engineers prefer using the more convenient decimal notation.
...
The need to flip the slide is a common trait of older Mannheim and Darmstadt rules. But it amounts to a design blunder on a modern duplex rule like the Logarex 27403-X. And the plastic of this rule is not much better than that of a cheap soap dish.
