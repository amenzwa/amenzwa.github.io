...
RPN keystroke programming is similar to the macro recording facility of a word processor. To create a programme on a programmable RPN calculator like the HP-15C, you press the `[g] [P/R]` key sequence to enter the programming (record) mode, punch in the desired keystrokes. 
